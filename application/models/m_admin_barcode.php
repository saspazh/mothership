<?php
class M_admin_barcode extends CI_Model{
    ...
    function get_product() {
		...
		$this->db->where('a.id_product = x.id_product');
        ...
        $query = $this->db->get('barang x,product a, poto b, kategori c');
		return $query->result();
    }

    function get_productx() {
	...
	function get_stok() {
		$this->db->select('a.serial as serial, c.nama_product, c.color, a.sizes, b.serial as serialstok');
