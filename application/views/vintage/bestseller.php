...
<!-- BEGIN .widget -->
			<div class="widget clearfix">
				...
				<div class="tag-title-wrap clearfix">
					<h3 class="tag-title-small">Best Sellers</h3>
				</div>
...
?>
					...
					?>
					<li>
						<a href="<?php  echo site_url()?>product/detail/<?php  echo $best->id_product ?>/<?php  echo $best->url_suffix?>" title="<?php  echo $best->nama_product ?>">
							<img src="<?php  echo base_url()?>/<?php  echo $best->path ?>/<?php  echo $best->file_name ?>" alt="<?php  echo $best->nama_product ?>" />
