                    ...
                    <div class="large-12 columns">
                        <div class="box">
                            ...
                            <div class="box-body " style="display: block;">
                                ...
                                <form action='<?php echo base_url()?>admin_project/editsave_project_detail' method='post'>
                                ...
                                <table style="width:100%;">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <?php echo $noUrut?>
                                                <input type='hidden' name='id_project_detail[]' value='<?php echo $value->id ?>'>
                                            </td>
                                            <td>
                                                <input type='text' name='detail[]' value='<?php echo $value->detail ?>'>
                                            </td>
                                            <td>
                                                <input type='text' name='amount[]' value='<?php echo $value->amount ?>'>
                                            </td>
