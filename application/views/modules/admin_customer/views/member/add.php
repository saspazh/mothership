<div class="row">
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <form role="form" action='<? echo site_url()?>admin_customer/save_distributor' method='post'>
			  ...
			  <div class="form-group">
                ...
                <textarea name='address1' class="form-control" rows="3"></textarea>
              </div>
			  ...
			  <div class="form-group">
                <label>Mobile</label>
                <input class="form-control" name='mobile' placeholder="ex. +628120000000">
              </div>
			  
			  <div class="form-group">
                <label>Email</label>
                <input class="form-control" name='email' type='email' placeholder="ex. name@mail.com">
              </div>
