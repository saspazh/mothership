...
?>	
	<h5 class="title"><span class="text"><? echo $this->session->flashdata('username') ?></span></h5>
	<h5 class="title"><span class="text"><? echo $this->session->flashdata('password') ?></span></h5>
<?
}
?>						
						
						<form action="<? echo base_url()?>register/save" method="post" class="form-stacked">
							<fieldset>
								<div class="control-group">
									<label class="control-label">Username</label>
									<div class="controls">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="password" name='password' placeholder="Enter your password" class="input-xlarge" id='passone'>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="password" name='password' placeholder="Confirm password" class="input-xlarge" id='passtwo'>
									</div>
								</div>
