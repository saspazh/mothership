              ...
              <table class="table table-bordered table-hover table-striped tablesorter">
                <thead>
                  <tr>
                    ...
                    <th rowspan='2'>Provit <i class="fa fa-sort"></i></th>
                    <th rowspan='2'>Laba <i class="fa fa-sort"></i></th>
                    <th rowspan='2'>Ket <i class="fa fa-sort"></i></th>
                    <th rowspan='2'>tanggal <i class="fa fa-sort"></i></th>
                  </tr>
                  <tr>
                    <th>persen <i class="fa fa-sort"></i></th>
                ...
                <tbody>
				  ...
				  <tr class="active">
                    ...
                    <td><?php echo $baris->margin ?> %</td>
                    <td><?php echo $baris->margin_nominal ?></td>
                    <td><?php echo $baris->provit ?></td>
                    <td><?php echo $baris->laba ?></td>
