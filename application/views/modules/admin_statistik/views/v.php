                ...
                <div class="row">
                    ...
                    <div class="large-12 columns">
                        <div class="box">
                            ...
                            <form action='<?php echo base_url() ?>admin_statistik' method='post'>
                                <fieldset>
                                ...
                                <table style="width:100%;">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $value->jumlah_pengunjung ?></td>
                                            <td>
                                                <a href="<?php echo base_url()?>admin_statistik/detail/'<?php echo $value->file_name ?>'" class="fontello-th-list" title="View detail"></a>
                                                <a href="<?php echo base_url()?>admin_statistik/grafik?file_name=<?php echo $value->file_name ?>" class="fontello-chart" title="Grafik"></a>
                                            </td>
