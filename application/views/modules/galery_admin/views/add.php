...
?>
        ...
        <form method="post" enctype="multipart/form-data" action="<? echo site_url()?>/galery_admin/do_upload " class="form" id="form">
            ...
            <fieldset>
                <legend>Entry Siswa</legend>
                    ...
                    <p class="inline-small-label">
                      ...
                      <input type="text" style="width: 50%;" class="text" name="judul" >          
                    </p>
                    ...
                    <p class="inline-small-label">
                      ...
                      <input type="checkbox" value="1" class="text" name="highlight" >          
                    </p>
