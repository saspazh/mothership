...
?>
											...
											<h4>Customer Detail</h4>
												<br>
													<address>
														<strong>Full Name:</strong> <span><? echo $this->session->userdata('first_name').' '.$this->session->userdata('last_name') ?></span><br>
														<strong>Company:</strong> <span><? echo $this->session->userdata('company') ?></span><br>
														<strong>Address:</strong> <span><? echo $this->session->userdata('address1') ?></span><br>
														<strong>City:</strong> <span><? echo $this->session->userdata('city') ?></span><br>								
														<strong>Province:</strong> <span><? echo $this->session->userdata('province') ?></span><br>								
														<strong>Email:</strong> <span><? echo $this->session->userdata('email') ?></span><br>								
														<strong>Mobile:</strong> <span><? echo $this->session->userdata('no_hp') ?></span><br>								
																						
													</address>									
												</div>
											
											<form action="<? echo site_url()?>checkout/confirm" id='form1' name='form1' class="form-horizontal" method='post'>
											<div class="span7">
												<h4>Cart</h4>
																...
																<table class="table table-striped">
																	...
																	?>
																		<tr>
																			...
																			<td width='15%'><a href="product_detail.html"><img alt=""  src="<? echo base_url()?>uploads/<? echo $items['file_name']?>"></a></td>
