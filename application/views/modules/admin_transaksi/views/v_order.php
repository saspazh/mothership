              ...
              <table class="table table-bordered table-hover table-striped tablesorter">
                ...
                <tbody>
				  ...
				  <tr class="active">
                    ...
                    <td>
						<a href='<?php echo site_url()?>admin_transaksi/v_order/<?php echo $baris->id_transaksi?>/<?php echo $this->uri->segment(3) ?>'>Detail</a> |
						<a href='<?php echo site_url()?>admin_transaksi/delete/<?php echo $baris->id_transaksi?>/<?php echo $this->uri->segment(3) ?>' onclick="return confirm('Anda yakin akan menghapus?')">delete</a>
					</td>
                  </tr>
				  <?php
				  $noUrut++;
